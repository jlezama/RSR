...
from models_search.building_blocks_search_leaky import Cell
...
class Generator(nn.Module):
    ...
    def forward(self, z):
        h0 = self.l1(z)
        h = h0.view(-1, self.ch, self.bottom_width, self.bottom_width)
...
class Discriminator(nn.Module):
    def __init__(self, args, activation=nn.LeakyReLU(0.01)):
