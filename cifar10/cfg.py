...
###### RSR starts here
    parser.add_argument(
        ...
        type=int,
        default=8192,
        help='initial large batch size')
    parser.add_argument(
        '--d_feature',
        type=int,
        default=2048,
        help='size of the feature embeddings')
    parser.add_argument(
        '--n_rotmat',
        type=int,
        default=4000,
        help='number of  feature embedding projections')
...
####### RSR ends here
    ...
    parser.add_argument(
        '--load_path',
        type=str,
        default='checkpoints/e2gan_cifar.pth',
